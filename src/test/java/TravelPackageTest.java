...
public class TravelPackageTest {
    ...
    void testPrintPassengerList() {
        ...
        passengers.add(new StandardPassenger("David Lee", 106, 210.0));
        passengers.add(new StandardPassenger("Mary White", 105, 180.0));
        passengers.add(new GoldPassenger("Sarah Green", 107, 320.0));
        passengers.add(new PremiumPassenger("Kevin Anderson", 110));
        ...
        String expectedOutput = "Travel Package: Test Package" + lineSeparator +
                ...
                "Enrolled Passenger Count: 4" + lineSeparator +
                " - Name: David Lee, ID: 106" + lineSeparator +
                " - Name: Mary White, ID: 105" + lineSeparator +
                " - Name: Sarah Green, ID: 107" + lineSeparator +
                " - Name: Kevin Anderson, ID: 110" + lineSeparator;
